...
int main()
{
   ...
   /* printf("\nLISTA DESORDENADA:\n");
    ...
    printf("\nORDENAMIENTO BURBUJA:\n");
    //graficoTiempoVRSBurbuja();
   // int *dinamBurbuja=(int*)malloc(numeroNodos*sizeof(int));
    ...
    printf("\nORDENAMIENTO QUICKSORT:\n");
    //int *dinamQuicksort=(int*)malloc(numeroNodos*sizeof(int));
    ordenamientoQuicksort(numeroNodos);
    ...
    //---------------------------
    graficoMinimoComparaciones(numeroNodos);
    //---------------------------
    graficoMovimientosMinimos(numeroNodos);
    //---------------------------
    free(raiz);
    free(listaInicial);
    free(listaFinal);
